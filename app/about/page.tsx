      ...
      <div className="min-h-screen bg-[#F5F1E8] text-black">
        ...
        <main className="pt-32 pb-20">
          <div className="max-w-4xl mx-auto px-8">
            ...
            >
              <p>
                We are Reform Collective, a creative digital agency dedicated to crafting exceptional digital
                experiences that inspire, engage, and drive results.
              </p>
              <p>
                Our team of passionate designers, developers, and strategists work collaboratively to bring your vision
